...
//		assertThat(RecipeIngredient.parse("1/3 teaspoon salt").getUnit(), is(MeasureUnit.TEASPOON));
		assertThat(RecipeIngredient.parse("500 grams flour").getUnit().getId(), is("Gram"));
		assertThat(RecipeIngredient.parse("1/2 cup sugar").getUnit().getId(), is("Cup"));
		assertThat(RecipeIngredient.parse("1l milk").getUnit().getId(), is("Litre"));
		assertThat(RecipeIngredient.parse("1/3 teaspoon salt").getUnit(), is("Teaspoon"));
	}
